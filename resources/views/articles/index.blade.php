...
<body class="bg-[#f8f9fb] min-h-screen py-10 px-6 text-gray-800">

    <div class="max-w-6xl mx-auto">
        <x-back-to-dashboard>Kembali</x-back-to-dashboard>

        @if (session('success'))
        <div id="alert-success" class="bg-green-100 border border-green-300 text-green-800 px-4 py-3 rounded-lg mb-6 shadow-sm mt-4">
            ✅ {{ session('success') }}
        </div>
        @endif
        ...
        <div class="bg-white shadow-lg rounded-3xl p-6 border border-[#e2e8f0]">
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 text-gray-700">
                        ...
                        <tr class="hover:bg-[#f9fafc] transition-colors">
                            ...
                            <td class="px-5 py-4">{{ $article->published_at ? \Carbon\Carbon::parse($article->published_at)->format('d M Y') : '-' }}</td>
            ...
            <div class="text-center py-12 text-gray-500">
                <svg class="mx-auto h-16 w-16 text-[#cbd5e1]" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6 1.5a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
